<?php
    class Ticket extends Conectar{
        ...
        public function delete_tickets($tick_id){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="UPDATE `tm_ticket`
                 SET 
        ...
        public function insert_tickets($tick_titulo,$tick_descrip,$tick_estado,$cat_id){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="INSERT INTO tm_ticket (tick_id, tick_titulo, tick_descrip, tick_estado, cat_id);";
            $sql=$conectar->prepare($sql);
            $sql->bindValue(1, $tick_titulo);
            $sql->bindValue(2, $tick_descrip);
        ...
        public function update_tickets($tick_id,$tick_titulo,$tick_descrip,$tick_estado,$cat_id){
            $conectar= parent::conexion();
            parent::set_names();
